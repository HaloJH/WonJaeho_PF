...
export const PROJECTS = [
  {
    ...
    contributions: [
      ...
      {
        title: '전자결재(MIKEP) 연동 / 첨부파일 / 이력 추적',
        items: [
          'SIGN_DOC/SIGN_LINE XML 구조 기반 결재 호출 흐름 구현 (TRANSACTION_KEY 패턴, gianCall.do 팝업).',
          'BIZ_ATTACH_FILE TASK_TYPE/CODE 길이 제약 발견 → 표준 코드 체계 정립.',
          'BIZ_PORTAL_CHANGE_LOG 기반 변경 이력 시스템 + BrVersionSelect 연동.',
        ],
      },
    ],
